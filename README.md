...
- **Ownership rules** — an HUF-held fund is visible in Portfolio but excluded from every dashboard figure and every return, because it is a different entity's money
